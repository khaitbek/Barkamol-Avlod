...
export const StyledHeroSocialList = styled(motion.ul).attrs({ className: "overflow-hidden grid gap-[10px] p-[10px] rounded-[100vmax] absolute left-[14%] bg-white" })`
    
`

export const StyledHeroSocialItem = styled.li``;
export const StyledHeroSocialLink = styled.a``;
export const StyledHeroSocialImage = styled.img.attrs({ className: "w-[40px] h-[40px]" })``;
